...
const About = () => {
  ...
  return (
    <section className="min-h-[85vh] lg:min-h-[78vh] ss:mt-3" id="about" ref={ref}>
      <div className="container mx-auto">
        <div className="flex flex-col gap-y-10 lg:flex-row lg:items-center lg:gap-x-20 lg:gap-y-0 h-screen">
          ...
          <motion.div
            ...
            className="flex-1 bg-contain bg-no-repeat h-[640px] mix-blend-lighten bg-top  items-center justify-center hidden lg:flex max-w-[320px] lg:max-w-[482px]"
          >
          ...
          <motion.div
            ...
            className="flex-1"
          >
            <h2 className="h2 text-accent mt-8">About me.</h2>
            <h3 className="h3 mb-4">
              I'm an aspiring and Freelance Front-end Developer & Flutter Developer.
            </h3>
            <p className="mb-6">
              {" "}
